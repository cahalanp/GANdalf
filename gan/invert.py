...
def invert_molecules(nn_G, info, GS, train_data, **kwargs):
    """
    ...
    return utils.gen_xyz(nn_G, info, GS, train_data, **default_kwargs)

#-----------------------------------------------------------------------------------------------------------------------
# Plot pyscf energy partity for Real
#-----------------------------------------------------------------------------------------------------------------------    
...
def main() -> None:
    ...
    # Load models
    _, nn_G = train.load_models(info, GS)

    # Load 
    trjs, losses, _ = invert_molecules(nn_G, info, GS, train_data)
